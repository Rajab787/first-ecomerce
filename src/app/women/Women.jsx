...
const page = () => {
 ...
 useEffect(() => {
    ...
    return (
        <div>
            <div>
                <div className='max-w-[2000px] lg:mt-16 mt-20 m-auto '>
                    <div className='bg-[#139695]  w-full flex items-center justify-start lg:justify-center h-[5rem] text-center lg:h-[4rem]  ' >

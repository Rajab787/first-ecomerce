...
export default function MegaMenu({
  ...
  imageSrc = "Home/cover-img-1.jpg", // replace with your image
}) {
  ...
  <div
    ...
    className={`
      absolute top-0  w-screen   -translate-x-[36.9%]  
       m-auto 
  ...
  >
    ...
    <div
      className={`bg-white h-[21rem] max-w-[2000px] w-[60%] mt-4 shadow-lg border border-gray-100 rounded-md overflow-hidden m-auto

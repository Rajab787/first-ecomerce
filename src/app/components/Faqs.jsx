    ...
    return (
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="text-center mb-12">
                <h1 className="lg:text-4xl text-3xl font-bold text-gray-900 mb-2 lg:mb-4">FAQ</h1>
                <p className="lg:text-xl text-[16px] text-gray-600 mb-3 lg:mb-6">Answers to Your Questions</p>
                <p className="lg:text-lg text-[16px] text-gray-500 max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="space-y-4 mb-12">
                {faqData.map((faq, index) => (
                    ...
                    >
                        ...
                        >
                            <span className="lg:text-lg text-[16px] font-semibold text-gray-900 pr-4">
                                {faq.question}
                            </span>
                            {activeIndex === index ? (
